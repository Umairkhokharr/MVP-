...
def main_page():
    ...
    st.image("https://via.placeholder.com/600x200?text=MerchSentAI+Logo", width=300, use_column_width=True, output_format='auto')
...
def analysis_page():
    ...
    if st.session_state.data is not None:
        ...
        with st.expander("📊 Data Enrichment", expanded=True):
            ...
            df['Enriched_Location'] = df['Country'] + " | " + df['Region']
